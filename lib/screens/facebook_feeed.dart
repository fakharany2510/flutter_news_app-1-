...
class FaceBookFeed extends StatefulWidget {
  static String routeName='FaceBookFeed';
  @override
            ...
            Padding(
                ...
                child:Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(image: ExactAssetImage('assets/images/face1.png'),fit: BoxFit.fill),
                  ),
                )),
            Column(
  ...
  Widget _drawBody(){
    return Column(
      ...
      children: [
        ...
        Padding(
          padding: EdgeInsets.only(left: 18 , right: 18),
          child: Text('#advanced dream Facebook' , style: TextStyle(
        ...
        Container(
          ...
          decoration: BoxDecoration(
            shape: BoxShape.circle,
            image: DecorationImage(image: ExactAssetImage('assets/images/face2.png'),fit: BoxFit.fill),
          ),
        )
      ],
    );
